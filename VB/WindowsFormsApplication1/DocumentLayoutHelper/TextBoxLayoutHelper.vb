...
Namespace WindowsFormsApplication1.DocumentLayoutHelper
	Public NotInheritable Class TextBoxLayoutHelper
        ...
        Public Shared Function GetInformationAboutCurrentTextBoxContent(ByVal currentTextBox As LayoutTextBox, ByVal currentLayout As DocumentLayout) As String
            ...
            returnedInformation &= String.Format("Plain text: {0}" & Constants.vbCrLf, plainTextContent)
            Return returnedInformation
        End Function
    End Class
End Namespace
